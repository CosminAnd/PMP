...
if __name__ == '__main__':
    ...
    #Ex2
    #(Rhat)
    summaries = pd.concat([az.summary(az.load_arviz_data("centered_eight"), var_names=['mu','tau']), az.summary(az.load_arviz_data("non_centered_eight"),var_names=['mu', 'tau'])])
